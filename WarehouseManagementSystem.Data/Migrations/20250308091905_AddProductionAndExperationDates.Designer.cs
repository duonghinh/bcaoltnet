...
namespace WarehouseManagementSystem.Data.Migrations
{
    ...
    [Migration("20250308091905_AddProductionAndExperationDates")]
    partial class AddProductionAndExperationDates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Data.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 8, 9, 19, 4, 282, DateTimeKind.Utc).AddTicks(830),
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Data.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "ITM001",
                            CreatedAt = new DateTime(2025, 3, 8, 9, 19, 4, 281, DateTimeKind.Utc).AddTicks(7168),
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Data.Models.StockItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            WarehouseId = 1,
                            ItemId = 1,
                            CreatedAt = new DateTime(2025, 3, 8, 9, 19, 4, 282, DateTimeKind.Utc).AddTicks(1872),
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Data.Models.Supplier", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 8, 9, 19, 4, 281, DateTimeKind.Utc).AddTicks(8710),
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Data.Models.SupplyOrder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 8, 9, 19, 4, 282, DateTimeKind.Utc).AddTicks(3276),
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Data.Models.SupplyOrderDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SupplyOrderId = 1,
                            ItemId = 1,
                            CreatedAt = new DateTime(2025, 3, 8, 9, 19, 4, 282, DateTimeKind.Utc).AddTicks(4876),
                            Id = 0,
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Data.Models.Warehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 8, 9, 19, 4, 281, DateTimeKind.Utc).AddTicks(516),
                            Manager = "John Doe",
                            Name = "Main Warehouse"
                        });
                });
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Data.Models.WithdrawalOrder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 8, 9, 19, 4, 282, DateTimeKind.Utc).AddTicks(6666),
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderNumber = "WO001",
                            WarehouseId = 1
            ...
            modelBuilder.Entity("WarehouseManagementSystem.Data.Models.WithdrawalOrderDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            WithdrawalOrderId = 1,
                            ItemId = 1,
                            CreatedAt = new DateTime(2025, 3, 8, 9, 19, 4, 282, DateTimeKind.Utc).AddTicks(7883),
                            Id = 0,
                            Quantity = 5
                        });
                });
