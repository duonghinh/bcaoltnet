namespace WarehouseManagementSystem.Presenation.Forms
{
    partial class ItemsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnExportExcel.Location = new Point(560, 10);
            ...
            label2.Text = "Mã hàng";
            txtCode.Location = new Point(380, 47);
            txtCode.Size = new Size(150, 27);
            label3.Location = new Point(550, 50);
            label3.Text = "ĐVT";
            cmbUnit.Location = new Point(600, 47);
            cmbUnit.Size = new Size(100, 28);
            label5.Location = new Point(720, 50);
            label5.Text = "Nhóm";
            cmbCategory.Location = new Point(780, 47);
            cmbCategory.Size = new Size(120, 28);
            ...
            btnAdd.Location = new Point(900, 45);
            btnAdd.Text = "Thêm";
            btnAdd.BackColor = Color.Lime;
            btnAdd.Click += btnAdd_Click;
            btnUpdate.Location = new Point(900, 85);
            btnUpdate.Text = "Cập nhật";
            btnUpdate.BackColor = Color.DodgerBlue;
            btnUpdate.ForeColor = Color.White;
            btnUpdate.Click += btnUpdate_Click;
            btnDelete.Location = new Point(1020, 85);
            btnDelete.Text = "Xóa";
