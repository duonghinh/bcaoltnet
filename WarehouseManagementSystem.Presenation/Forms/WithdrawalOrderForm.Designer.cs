namespace WarehouseManagementSystem.Presenation.Forms
{
    partial class WithdrawalOrderForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            cmbItem.Size = new Size(350, 28);
            cmbItem.SelectedIndexChanged += cmbItem_SelectedIndexChanged;
            lblStockInfo.Location = new Point(380, 308);
            lblStockInfo.Size = new Size(200, 23);
            txtQty.Location = new Point(600, 305);
            txtQty.Width = 80;
            btnAddLine.Location = new Point(700, 303);
            btnAddLine.Text = "Thêm dòng";
            btnAddLine.Click += btnAddLine_Click;
            btnRemoveLine.Location = new Point(820, 303);
